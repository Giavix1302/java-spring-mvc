...
public class ProductService {
  ...
  public Page<Product> getAllProductWithSpec(Pageable pageable, ProductCriteriaDTO productCriteriaDTO) {
    ...
    if (productCriteriaDTO.getPrice() != null && productCriteriaDTO.getPrice().isPresent()) {
      Specification<Product> currentSpecs = this.getAllProductWithPriceRange(productCriteriaDTO.getPrice().get());
      combinedSpec = combinedSpec.and(currentSpecs);
    }
  ...
  // public Page<Product> getAllProductWithMinPrice(Pageable pageable, Number
  // minPrice) {
  // return this.productRepository.findAll(ProductSpecs.minPrice(minPrice),
  // pageable);
  // }

  // public Page<Product> getAllProductWithMaxPrice(Pageable pageable, Number
  // maxPrice) {
  // return this.productRepository.findAll(ProductSpecs.maxPrice(maxPrice),
  // pageable);
  // }

  // public Page<Product> getAllProductWithFactory(Pageable pageable, String
  // factory) {
  // return this.productRepository.findAll(ProductSpecs.matchFactory(factory),
  // pageable);
  // }

  // public Page<Product> getAllProductWithFactory(Pageable pageable, List<String>
  // factories) {
  // return
  ...
  // public Page<Product> getAllProductWithPriceRange(Pageable pageable, String
  // price) {
  ...
  public Specification<Product> getAllProductWithPriceRange(List<String> prices) {
    Specification<Product> combinedSpec = Specification.where(null);
    for (String p : prices) {
      double min = 0;
      double max = 0;
  ...
  public void handleRemoveCartDetail(long cartDetailId, HttpSession session) {
    ...
    if (cartDetailOptional.isPresent()) {
      ...
      // update cartAdd commentMore actions
